...
# Add RL root directory to path for data_pipeline imports
rl_root = Path(__file__).parent.parent.parent
...
async def startup_event():
    ...
    # Load base model
    model_path = os.getenv('MODEL_PATH', '../../models/gpu_trained/fresh_ppo_model.zip')
