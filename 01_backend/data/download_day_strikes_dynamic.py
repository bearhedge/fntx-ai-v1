#!/usr/bin/env python3
"""
Dynamic Strike-aware daily downloader for 0DTE SPY options
...
class DynamicStrikeDownloader:
    ...
    def get_checkpoint_filename(self, date: datetime) -> str:
        ...
        return f"checkpoint_{date.strftime('%Y%m%d')}_dynamic.json"
...
def main():
    parser = argparse.ArgumentParser(description='Download 0DTE data with dynamic volatility-based strike selection')
    ...
    # Create downloader
    downloader = DynamicStrikeDownloader(
