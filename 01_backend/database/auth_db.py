...
from 01_backend.models.user import User
    ...
    def __init__(self, db_path: str = None):
        ...
        if db_path is None:
            ...
            try:
                ...
                # Fallback: find project root by looking for 01_backend directory
                current_dir = os.path.dirname(os.path.abspath(__file__))
                while current_dir != "/" and current_dir:
                    if os.path.exists(os.path.join(current_dir, "01_backend")):
