    ...
    def _check():
        try:
            ...
            with conn.cursor() as cursor:
                ...
                if not columns:
                    return False, "Exercise table not found - run: psql -d fntx_trading -f 03_database/portfolio/003_exercise_tracking.sql"
...
def suggest_next_steps(results):
    ...
    if not results.get('database', False):
        ...
        critical_issues.append("   - Run: psql -d fntx_trading -f 03_database/portfolio/003_exercise_tracking.sql")
