-- Master Trading Database - Phase 2: Staging Schema & Validation
-- This creates the staging infrastructure for safe data imports
-- Run with: psql -U info -d fntx_trading -f 02_staging_schema.sql
    ...
    LOOP
        ...
        LOOP
            INSERT INTO staging.validation_results (
                ...
                p_import_id, v_staging_id, v_rule.rule_id, v_rule.severity, v_rule.error_message
            );
        END LOOP;
    END LOOP;
