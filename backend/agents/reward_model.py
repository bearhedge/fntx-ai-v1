...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/Users/jimmyhou/CascadeProjects/fntx-ai-v10/logs/reward_model.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger('RewardModelAgent')
...
class RewardModelAgent:
    ...
    def __init__(self):
        self.memory_file = "backend/agents/memory/reward_model_memory.json"
        self.shared_context_file = "backend/agents/memory/shared_context.json"
        self.executor_memory_file = "backend/agents/memory/executor_memory.json"
